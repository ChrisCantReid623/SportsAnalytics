"""
launchAngleOnlyLinear.py
Homework 4: Predicting Batted Ball Distance with Linear Regression (Launch Angle Only)

Author: Christopher Reid
Course: 496 Sports Analytics, Fall 2024

This script performs a linear regression to predict the distance of a batted ball based on launch angle only.
It outputs the mean squared error and the model's coefficients.

Additionally, the script generates a plot of launch angle vs. hit distance with a regression line.
...
Example command:
$ python launchAngleOnlyLinear.py all2024.csv
"""
...
def main(filename='all2024.csv'):
    ...
    if display_plots:
        ...
        plt.title('Launch Angle vs Hit Distance')
