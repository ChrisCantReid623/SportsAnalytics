"""
analyze_combine_data.py

This script analyzes NBA Draft Combine data. It identifies top performers for all metrics
and visualizes the distributions of each numeric metric in the dataset.
...
if __name__ == "__main__":
    input_file = "combine_cleaned_data.csv"
